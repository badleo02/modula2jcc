...
public class Scanner {
    ...
    public Scanner(Reader in, GestorErrores gestorErrores, TablaDeSimbolos tablaSimbolos) {
        ...
        zzReader = in;
        _tablaDeSimbolos = tablaSimbolos;
